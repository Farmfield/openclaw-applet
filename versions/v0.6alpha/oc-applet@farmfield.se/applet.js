...
MyApplet.prototype = {
    ...
    _setupMenu: function() {
        try {
            ...
            global.log("OC-Applet: Models loaded from JSON: " + JSON.stringify(models));
            ...
            let versionLabel = new St.Label({ text: "0.6a - ByFarmfield - 2026", style: "font-size: 9px; color: #888888;" });
