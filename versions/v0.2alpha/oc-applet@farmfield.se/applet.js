...
MyApplet.prototype = {
    ...
    _setupMenu: function() {
        try {
            ...
            // Reduce menu item padding via style
            this.menu.actor.style = "padding: 0px;";
            this.menu.box.style = "padding: 0px; spacing: 0px;";

            // Style helper function
            let reducePadding = function(actor) {
                actor.style = "padding: 2px 4px;";
            };
            ...
            item1.actor.style = "padding: 2px 4px;";
            item1.connect('activate', Lang.bind(this, function() {
                global.log("OC-Applet: OC Start clicked");
                Util.spawnCommandLine("bash -c 'openclaw gateway start'");
                this.menu.close();
            }));
            ...
            item2.actor.style = "padding: 2px 4px;";
            item2.actor.style = "padding: 2px 4px;";
            item2.connect('activate', Lang.bind(this, function() {
                global.log("OC-Applet: OC Stop clicked");
                Util.spawnCommandLine("bash -c 'openclaw gateway stop'");
                this.menu.close();
            }));
            ...
            item3.actor.style = "padding: 2px 4px;";
            item3.actor.style = "padding: 2px 4px;";
            item3.connect('activate', Lang.bind(this, function() {
                global.log("OC-Applet: OC Restart clicked");
                Util.spawnCommandLine("bash -c 'openclaw gateway restart'");
                this.menu.close();
            }));
            ...
            item4.actor.style = "padding: 2px 4px;";
            item4.actor.style = "padding: 2px 4px;";
            ...
            item5.actor.style = "padding: 2px 4px;";
            ...
            item6.actor.style = "padding: 2px 4px;";
            ...
            item7.actor.style = "padding: 2px 4px;";
            item7.actor.style = "padding: 2px 4px;";
            item7.connect('activate', Lang.bind(this, function() {
                Util.spawnCommandLine("x-terminal-emulator -e 'bash -c \"openclaw doctor --fix; echo; echo Press Enter to close; read\"'");
                this.menu.close();
            }));
