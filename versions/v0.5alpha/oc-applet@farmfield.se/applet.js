    ...
    _setupMenu: function() {
        try {
            ...
            let models = [
                ...
                {name: "Kimi K2.5 (@nvidia)", cmd: "/usr/bin/openclaw models set nvidia/moonshotai/kimi-k2.5"},
                ...
                {name: "Gemini 3 Pro (Google)", cmd: "/usr/bin/openclaw models set google/gemini-3-pro"}
            ];
            ...
            // Footer text (right aligned) - add directly to menu box
            let footerLabel = new St.Label({ text: "v2.3 - ByFarmfield - 2026", style: "font-size: 9px; color: #888888;" });
            this.menu.box.add(footerLabel, { expand: true, x_fill: false, x_align: St.Align.END });
